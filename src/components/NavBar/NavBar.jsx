    ...
    <div className="fixed z-10 w-full max-w-[1440px]">
      ...
      <nav
        className={`fixed w-2/3 ${
          isMenuOpen
            ? "top-0 right-0 left-0 bottom-0 lg:bottom-auto"
            : "top-0 right-0 bottom-0 -left-full"
        } duration-1000 z-10  bg-slate-100`}
      >
        <div
        ...
        >
          <AiOutlineClose
            className={`text-4xl text-white ${isMenuOpen ? "" : "hidden"}`}
          />
        </div>
